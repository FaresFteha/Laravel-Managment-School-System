...
class AttendanceRepository implements AttendanceRepositoryInterface
{
    ...
    public function show($id)
    {
        ...
        $students = Student::with('attendance')->where('section_id', $id)->paginate(5);
        $students_Display = Student::with('attendance')->where('section_id', $id)->get();
        return view('pages.Attendance.index', compact('students' , 'students_Display'));
    }
