                            ...
                            <div class="form-row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        <label for="Grade_id">{{ trans('students_trans.Subj') }} : <span
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        <label for="Grade_id">{{ trans('students_trans.nametrcher') }} : <span
                                                class="text-danger">*</span></label>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select mr-sm-2" id="Classroom_id" name="Classroom_id">
                                            <option value="{{ $quizz->id }}">{{ $quizz->classroom->name_class }}
                                            </option>
                                        </select>
                                        @error('Classroom_id')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select mr-sm-2" id="section_id" name="section_id">
                                            <option value="{{ $quizz->id }}">{{ $quizz->section->name_sections }}
                                            </option>
                                        </select>
                                        @error('section_id')
                                        <div class="alert alert-danger">{{ $message }}</div>
