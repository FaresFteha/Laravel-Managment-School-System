                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered p-0">
                            ...
                            <tbody id="myTable">
                                @forelse($receipt_students as $receipt_student)
                                    <tr>
                                        ...
                                        <td > 
                                            ...
                                            <a class="btn btn-warning" role="button"
                                                href="{{ route('Invoice_Receipt', $receipt_student->id) }}"><i
                                                    style="color: rgb(0, 0, 0)" class="fa fa-print"></i>
                                            </a>
                                            @elsecan('Print Receipt')
                                            <a class="btn btn-warning" role="button"
                                            href="{{ route('Invoice_Receipt', $receipt_student->id) }}"><i
                                                style="color: rgb(0, 0, 0)" class="fa fa-print"></i>
                                            </a>
