           ...
           <div class="modal-content">
               <div class="modal-header">
                   <h5 style="font-family: 'Cairo', sans-serif;"
                       class="modal-title" id="exampleModalLabel">{{ trans('Library_trans.DeletBook') }}</h5>
               ...
               <div class="modal-body">
                   <p> {{ trans('classrooms_trans.Warning_class') }} <span class="text-danger">{{$book->title}}</span></p>
