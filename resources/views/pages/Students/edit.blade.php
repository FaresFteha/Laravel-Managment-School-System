                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ $Students->email }}" name="email" class="form-control" autocomplete="off">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>{{ trans('Students_trans.password') }} : <small style="color: red">{{ trans('Students_trans.Password_reserved') }}</small></label>
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select mr-sm-2" id="section_id" name="section_id">
                                    <option value="{{ $Students->section_id }}">
                                        {{ $Students->section->name_sections }}</option>
                                </select>
                            </div>
                        </div>
