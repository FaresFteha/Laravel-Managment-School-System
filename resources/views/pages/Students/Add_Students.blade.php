...
@section('title')
    {{ trans('main_siadebar_trans.Add_student') }}
@stop
    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                @endif
                <form method="post" action="{{ route('Sudents.store') }}" autocomplete="off"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <label class="form-check-label"
                                        for="exampleCheck1">{{ trans('Students_trans.Showpassword') }}</label>
                                </div>
                                @error('password')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select mr-sm-2" name="nationalitie_id">
                                    ...
                                    @foreach ($nationals as $nal)
                                        <option value="{{ $nal->id }}">{{ $nal->Nationalities }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select mr-sm-2" name="blood_id">
                                    ...
                                    @foreach ($bloods as $bg)
                                        <option value="{{ $bg->id }}">{{ $bg->Type_Blood }}</option>
                                    @endforeach
                                </select>
                                @error('blood_id')
                                    <div class="alert alert-danger">{{ $message }}</div>
                    ...
                    <div class="row pt-4">
                        <div class="col-12">
                            ...
                            <div class="file-loading">
                                <input type="file" name="file_name" id="photos" class="file-input-overview">
                            </div>
                        </div>
                    </div>
