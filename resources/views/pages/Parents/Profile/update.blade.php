...
@section('page-header')
<!-- breadcrumb -->
<h4 class="mb-0">{{trans('users_trans.Profilepersonly')}}: <label style="color: red">{{$information->Name_Father}} </label></h4>
            ...
            <div class="col-lg-4">
                <div class="card mb-4">
                    <div class="card-body text-center">
                        ...
                        <p class="text-muted mb-4">{{ trans('dashpored.Parents') }}</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-8">
                <div class="card mb-4">
                    <div class="card-body">
                        <form action="{{ route('profile.update.parent',$information->id) }}" method="post">
                            ...
                            <hr>
                            <div class="text-right align-self-center"><button type="submit"
                                    class="btn btn-success">{{ trans('fees_trans.Submite') }}</button></div>
                        </form>
                    </div>
                </div>
            </div>
