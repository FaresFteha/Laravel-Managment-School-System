...
@section('page-header')
    <div class="page-title">
        <div class="row">
            <div class="col-sm-6">
                <h4>{{ trans('invoices_trans.excludefee') }} : <label style="color: red">{{$student->name}}</label></h4>
        ...
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('ProccessingFeesStudent.store') }}" autocomplete="off">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
