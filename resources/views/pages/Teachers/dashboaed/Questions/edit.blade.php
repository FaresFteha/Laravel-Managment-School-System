        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                    ...
                    <li class="breadcrumb-item active"> {{ trans('Questions_trans.EditQuestion') }} </li>
                </ol>
            </div>
                ...
                <div class="col-xs-12">
                    <div class="col-md-12">
                        ...
                        <form action="{{ route('question.update', $question->id) }}" method="post" autocomplete="off">
                            ...
                            <div class="form-row">
                                <div class="col">
                                    <label for="title">{{ trans('Questions_trans.Answers') }} <span
                                            style="color: red; font-size: smaller">{{ trans('Questions_trans.betweenquestions') }}</span></label>
