           ...
           <div class="modal-content">
               <div class="modal-header">
                   <h5 style="font-family: 'Cairo', sans-serif;"
                       class="modal-title" id="exampleModalLabel">{{ trans('Questions_trans.DeleteQuestion') }}  </h5>
               ...
               <div class="modal-body">
                  <h5> <p> {{ trans('classrooms_trans.Warning_class') }} <span class="text-danger">{{$question->title}}</span></p></h5>
