            ...
            <ul class="nav navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown ">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-big">
                        ...
                        <div class="dropdown-divider"></div>
                        <div class="nav-grid">
                            <a href="{{ route('Student_Exams.index') }}" class="nav-grid-item"><i
                                    class="fa fa-braille text-warning"></i>
                                <h5>{{ trans('header_trans.Exam') }}</h5>
                            </a>
                            <a href="{{ route('Student.semesterMarks') }}" class="nav-grid-item"><i
                                    class="fa fa-line-chart text-success"></i>
                                <h5>{{ trans('header_trans.Semestermarks') }}</h5>
                            </a>
                        </div>
                        <div class="nav-grid">

                            <a href="{{ route('Student.examsSchedule') }}" class="nav-grid-item"><i
                                    class="fa fa-calendar text-danger "></i>
                                <h5>{{ trans('header_trans.examsschedule') }}</h5>
                            </a>

                            <a href="{{ route('Student.Zoom') }}" class="nav-grid-item"><i
                                    class="fa fa-video-camera text-primary"></i>
                ...
                <li class="nav-item dropdown mr-30">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="{{ route('Profile.Student') }}"><i
