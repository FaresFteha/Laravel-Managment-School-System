            ...
            <ul class="nav navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown ">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-big">
                        ...
                        <div class="dropdown-divider"></div>
                        <div class="nav-grid">
                            <a href="{{ route('Sections') }}" class="nav-grid-item"><i
                                    class="ti-list-ol text-primary"></i>
                                <h5>{{ trans('header_trans.Sections') }}</h5>
                            </a>
                            <a href="{{ route('quizzes.index') }}" class="nav-grid-item"><i
                                    class="ti-check-box text-success"></i>
                                <h5>{{ trans('header_trans.quizzes') }}</h5>
                            </a>
                        </div>
                        <div class="nav-grid">
                            <a href="{{ route('Attendance.report') }}" class="nav-grid-item"><i
                                    class="ti-pencil-alt text-warning"></i>
                                <h5>{{ trans('attendance_trans.Attendancereports') }}</h5>
                            </a>
                            <a href="{{ route('zoom.index') }}" class="nav-grid-item"><i
                                    class="ti-headphone-alt text-danger"></i>
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a class="dropdown-item" href="#"
                            onclick="event.preventDefault();this.closest('form').submit();"><i
                                class="fa fa-sign-out text-danger"></i>{{ trans('header_trans.signout') }}</a>
                        </form>
