    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-4 text-center text-md-start mb-3 mb-md-0">
                <!-- Logo START -->
                <a href="index-2.html"> <img class="h-20px" src="{{ asset('assets/logo-new-gen/new-gen.png') }}" 
                        alt="logo"> </a>
            </div>
            ...
            <div class="col-md-4 mb-3 mb-md-0">
                <div class="text-center text-white">
                    &copy; {{ trans('content_trans.Copyright') }} <span id="copyright">
                        <script>
                            document.getElementById('copyright').appendChild(document.createTextNode(new Date().getFullYear()))
                        </script> {{ trans('content_trans.Gaza') }}. <br>
                         <a href="https://github.com/FaresFteaha" target="_blank"
                            class="text-reset btn-link">{{ trans('content_trans.Fares') }}</a>
                </div>
            </div>
            <!-- Widget -->
            <div class="col-md-4">
...
{{-- <!-- =======================
Footer END -->
<footer class="pt-0 bg-primary position-relative overflow-hidden">
	...
	<div class="container position-relative">
		...
		<div class="row">
			<div class="col-lg-6 mx-auto text-center mb-5">
				<!-- Logo -->
				<a href="index-2.html"> <img class="h-40px src="{{ url::asset('assetshome/images/logo-light.svg') }}   alt="logo"> </a>
        ...
        <ul class="nav justify-content-center justify-content-center text-primary-hover mt-3 mt-md-0">
          ...
          <li class="nav-item"><a class="nav-link text-white pe-0" href="#">Cookies</a></li>
				...
				<!-- Bottom footer link -->
				<div class="text-white text-primary-hover mt-3"> Copyrights <a href="#" class="text-reset">©2021 Eduport</a>. All rights reserved. </div>
			</div>
		</div>
	</div>
</footer>
