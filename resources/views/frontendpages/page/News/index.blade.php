        ...
        <div class="container">
            <div class="row position-relative">
                ...
                <div class="col-lg-10 mx-auto text-center position-relative">
                    ...
                    <!-- Title -->
                    <h1>{{ trans('content_trans.latestnews') }}</h1>
                    <!-- Breadcrumb -->
                    <div class="d-flex justify-content-center position-relative">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0">
                                <li class="breadcrumb-item"><h5><a href="{{ route('selection') }}">{{ trans('header_trans.home') }}</a></h5></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="card bg-transparent">
                        <div class="overflow-hidden rounded-3">
                            <img src="{{asset('attachments/NewsSchool/' . $news->file_name) }}" class="card-img" alt="course image">
                            <!-- Overlay -->
                        ...
                        <div class="card-body">
                            <!-- Title -->
                            <h5 class="card-title"><a href="{{ route('News.Content' , $news->id) }}">{{  $news->Title  }}</a></h5>
                            <!-- Info -->
