        ...
        <div class="container">
            ...
            <div class="row align-items-center g-5">
                ...
                <div class="col-lg-5 col-xl-6 position-relative z-index-1 text-center text-lg-start mb-5 mb-sm-0">
                    ...
                    <!-- Title -->
                    <h1 class="mb-0 display-6">{{ trans('slider_trans.electronic ') }}
                        <span class="position-relative">{{ trans('slider_trans.Skills ') }}
                            <!-- SVG START -->
                    ...
                    <!-- Content -->
                    <p class="my-4 lead">{{ trans('slider_trans.aboutDiscover') }}</p>
                    ...
                    <ul class="list-inline position-relative justify-content-center justify-content-lg-start mb-4">
                        <li class="list-inline-item me-2"> <i
                                class="bi bi-patch-check-fill h6 me-1"></i>{{ trans('slider_trans.Accreditedcertificates') }}
                        </li>
                        <li class="list-inline-item me-2"> <i
                                class="bi bi-patch-check-fill h6 me-1"></i>{{ trans('slider_trans.Learnwithexperts') }}
                        </li>
                        <li class="list-inline-item"> <i
                                class="bi bi-patch-check-fill h6 me-1"></i>{{ trans('slider_trans.Moretechnical') }}
                        </li>
                    </ul>
                ...
                <div class="col-lg-7 col-xl-6 text-center position-relative">
                    ...
                    <div
                        ...
                        <img src="{{ asset('assetshome/images/client/science.svg') }}" alt="Icon">
                    </div>
                    <div class="p-2 bg-white shadow rounded-3 position-absolute top-0 end-0 me-5">
                        <img src="{{ asset('assetshome/images/client/pencil.svg') }}" alt="Icon">
                    </div>
                    <div
                        ...
                        <img src="{{ asset('assetshome/images/client/graduated.svg') }}" alt="Icon">
                    </div>
                    ...
                    <div
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="text-start ms-3">
                                <h6 class="mb-0 text-white">{{ trans('slider_trans.Congratulations') }} <span
                                        class="ms-4"><i class="fas fa-check-circle text-success"></i></span>
                                </h6>
                                <p class="mb-0 small text-white">{{ trans('slider_trans.rightplace') }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-3 bg-success d-inline-block rounded-4 shadow-lg position-absolute top-50 end-0 translate-middle-y mt-n7 z-index-1 d-none d-md-block"
                        style="background:url(assetshome/images/pattern/01.png) no-repeat center center; background-size:cover;">
                        <p class="text-white">{{ trans('slider_trans.Ourdailynewstudents') }}</p>
                    ...
                    <div class="position-relative">
                        <img src="{{ asset('assetshome/images/element/07.png') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="d-flex justify-content-center align-items-center p-4 bg-warning bg-opacity-15 rounded-3">
                        ...
                        <div class="ms-4 h6 fw-normal mb-0">
                            ...
                            <p class="mb-0">{{ trans('content_trans.modern') }}</p>
                        </div>
                    </div>
                </div>
                <!-- Counter item -->
                <div class="col-sm-6 col-xl-3">
                    <div class="d-flex justify-content-center align-items-center p-4 bg-blue bg-opacity-10 rounded-3">
                        ...
                        <div class="ms-4 h6 fw-normal mb-0">
                            <div class="d-flex">
                                <h5 class="mb-0 fw-bold" data-purecounter-start="0"
                                    data-purecounter-delay="200">{{\App\Models\myparent::count()  }}</h5>
                                <span class="mb-0 h5">+</span>
                            </div>
                            <p class="mb-0">{{ trans('content_trans.teachers') }}</p>
                        </div>
                    </div>
                </div>
                <!-- Counter item -->
                <div class="col-sm-6 col-xl-3">
                    <div class="d-flex justify-content-center align-items-center p-4 bg-purple bg-opacity-10 rounded-3">
                        ...
                        <div class="ms-4 h6 fw-normal mb-0">
                            <div class="d-flex">
                                <h5 class="mb-0 fw-bold" data-purecounter-start="0"  
                                    data-purecounter-delay="200">{{ \App\Models\Student::count() }}</h5>
                                <span class="mb-0 h5">K+</span>
                            </div>
                            <p class="mb-0">{{ trans('content_trans.Affiliate') }}</p>
                        </div>
                    </div>
                </div>
                <!-- Counter item -->
                <div class="col-sm-6 col-xl-3">
                    <div class="d-flex justify-content-center align-items-center p-4 bg-info bg-opacity-10 rounded-3">
                        ...
                        <div class="ms-4 h6 fw-normal mb-0">
                            ...
                            <p class="mb-0">{{ trans('content_trans.accreditation') }}</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row mb-4">
                <div class="d-md-flex justify-content-md-between align-items-center">
                    <div>
                        <span class="me-2">{{ trans('content_trans.readmore') }}</span>
                        <a href="{{ route('News')}}" class="btn btn-sm btn-primary-soft mb-0">{{ trans('content_trans.here') }}<i
            ...
            <div class="row g-4">
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="card bg-transparent">
                        <div class="overflow-hidden rounded-3">
                            <img src="{{ asset('attachments/NewsSchool/' . $news->file_name ) }}" class="card-img"
                                alt="course image">
                            <!-- Overlay -->
                        ...
                        <div class="card-body">
                            <!-- Title -->
                            <h5 class="card-title"><a href="{{ route('News.Content' ,$news->id ) }}">{{ $news->Title }}</a>
                            </h5>
                            {{-- <p class="text-truncate-2">{!! $news->content !!}</p> --}}
                            <!-- Info -->
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="card bg-transparent">
                        <div class="overflow-hidden rounded-3">
                            <img src="{{ asset('assetshome/images/event/08.jpg') }}" class="card-img"
                                alt="course image">
                            <!-- Overlay -->
                            <div class="bg-overlay bg-dark opacity-4"></div>
                            <div class="card-img-overlay d-flex align-items-start p-3">
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-truncate-2">Prospective students should start broadly and then narrow
                                their list down to colleges that best fit their needs, experts say. Yet remarkably
                                appearance get him his projection.</p>
                            <!-- Info -->
                            <div class="d-flex justify-content-between">
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="card bg-transparent">
                        <div class="overflow-hidden rounded-3">
                            <img src="{{ trans('assetshome/images/event/09.jpg') }}" class="card-img"
                                alt="course image">
                            <!-- Overlay -->
                            <div class="bg-overlay bg-dark opacity-4"></div>
                            <div class="card-img-overlay d-flex align-items-start p-3">
                        ...
                        <div class="card-body">
                            <!-- Title -->
                            <h5 class="card-title"><a href="#">Never underestimate the influence of
                                    Eduport</a></h5>
                            <p class="text-truncate-2">Prospective students should start broadly and then narrow
                                their list</p>
                            <!-- Info -->
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="card bg-transparent">
                        <div class="overflow-hidden rounded-3">
                            <img src="{{ trans('assetshome/images/event/03.jpg') }}" class="card-img-top"
                                alt="course image">
                            <!-- Overlay -->
                            <div class="bg-overlay bg-dark opacity-4"></div>
                            <div class="card-img-overlay d-flex align-items-start p-3">
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-truncate-2">Rooms oh fully taken by worse do. Points afraid but may end
            ...
            <div class="row">
                <div class="col-12 position-relative z-index-1">
                    ...
                    <div class="d-none d-lg-block position-absolute bottom-0 start-0 ms-5">
                        <img src="{{ asset('assetshome/images/element/02.png') }}" alt="Image">
                    </div>
                    <div class="bg-primary p-4 p-sm-5 rounded position-relative z-index-n1 overflow-hidden">
                        <!-- SVG decoration -->
                        <figure class="position-absolute top-50 end-0 translate-middle-y me-n7">
                            <svg class="fill-danger rotate-193 opacity-2" width="676px" height="161.3px"
                                ...
                                <div class="row g-3 d-flex align-items-center justify-content-center">
                                    ...
                                    <div class="col-sm-6 col-lg-3 text-center">
                                        <div class="d-flex justify-content-center">
                                            <h4 class=" display-6 text-white fw-bold mb-0"
                                                data-purecounter-start="0" data-purecounter-delay="200">{{ \App\Models\Classroom::count() }}</h4>
                                            <span class="display-6 text-white mb-0">+</span>

                                        </div>
                                        <h6 class="text-white mb-0 fw-bold">{{ trans('content_trans.Classroom') }}
                                        </h6>
                                    </div>
                                    ...
                                    <div class="col-sm-6 col-lg-3 text-center">
                                        <div class="d-flex justify-content-center">
                                            <h4 class="display-6 text-white fw-bold mb-0"   data-purecounter-start="0" data-purecounter-delay="200">{{ \App\Models\Section::count() }}</h4>
                                            <span class="display-6 text-white mb-0">+</span>

                                        </div>
                                        <h6 class="text-white mb-0 fw-bold">
                                            {{ trans('content_trans.departments') }}</h6>
                                    </div>
                                    ...
                                    <div class="col-sm-6 col-lg-3 text-center">
                                        <div class="d-flex justify-content-center">
                                            <h4 class="display-6 text-white fw-bold mb-0"
                                                ...
                                                data-purecounter-delay="200">{{ \App\Models\OnlineClasse::count() }}</h4>
                                            <span class="display-6 text-white mb-0">+</span>
                                        </div>
                                        <h6 class="text-white mb-0 fw-bold">{{ trans('content_trans.Zoom') }}</h6>
                                    </div>
                                    ...
                                    <div class="col-sm-6 col-lg-3 text-center">
                                        <div class="d-flex justify-content-center">
                                            <h4 class="display-6 text-white fw-bold mb-0"
                                                data-purecounter-start="0" data-purecounter-delay="200">{{ \App\Models\Library::count() }}</h4>
                                            <span class="display-6 text-white mb-0">+</span>
                                        </div>
                                        <h6 class="text-white mb-0 fw-bold">{{ trans('content_trans.books') }}
                                        </h6>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="container">
            <div class="row position-relative">
                ...
                <div class="col-lg-10 mx-auto text-center position-relative">
                    ...
                    <!-- Title -->
                    <h1>{{ trans('content_trans.Event') }}</h1>
                    <!-- Breadcrumb -->
                </div>
            </div>
        </div>
                ...
                <div class="tiny-slider arrow-round arrow-creative arrow-blur">
                    <div class="tiny-slider-inner" data-autoplay="false" data-arrow="true" data-dots="false"
                        ...
                        @foreach ($events as $event)
                            <div class="card bg-transparent">
                                <div class="position-relative">
                                    <img src="{{ asset('attachments/EventsSchool/' . $event->file_name) }}"
                                    ...
                                    <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                                        ...
                                        <div class="w-100 mt-auto">
                                            <!-- Category -->
                                            <a class="badge text-dark bg-white fs-6 rounded-1"><i
                                                    class="far fa-calendar-alt text-orange me-2"></i>{{ $event->event_date }}</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body px-2">
                                    <!-- Title -->
                                    <h5 class="card-title"><a>{{ $event->name_event }}</a></h5>
                                </div>
                            </div>
                        @endforeach
                    </div>
                    ...
                    <div class="row mt-0 mt-xl-5">
                            ...
                            <div class="bg-body shadow text-center p-4 rounded-3 position-relative mb-5 mb-md-0">
                                ...
                                <blockquote>
                                    <p>
                                        ...
                                        {{ trans('content_trans.AhmedRamibio') }}
                                ...
                                <!-- Info -->
                                <h6 class="mb-0">{{ trans('content_trans.AhmedRami') }}</h6>
                            </div>
                        </div>
                        ...
                        <div class="col-md-5 mt-5 mt-md-0 d-none d-md-block">
                            <div class="bg-body shadow p-4 rounded-3 d-inline-block position-relative">
                                ...
                                <!-- Title -->
                                <h6 class="mb-3">{{ trans('content_trans.VerifiedTeacher') }}</h6>
                                <!-- Mentor Item -->
                                <div class="d-flex align-items-center mb-3">
                                    <!-- Avatar -->
                                    <div class="avatar avatar-sm">
                                        <img class="avatar-img rounded-1"
                                            src="{{ asset('assetshome/images/avatar/05.jpg') }}" alt="avatar">
                                    </div>
                                    <!-- Info -->
                                    <div class="ms-2">
                                        <h6 class="mb-0">{{ trans('content_trans.Mai') }}</h6>
                                        <p class="mb-0 small">{{ trans('content_trans.Tutorofphysic') }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <!-- Info -->
                                    <div class="ms-2">
                                        <h6 class="mb-0">{{ trans('content_trans.Wael') }}</h6>
                                        <p class="mb-0 small">{{ trans('content_trans.Tutorofmath') }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <!-- Info -->
                                    <div class="ms-2">
                                        <h6 class="mb-0">{{ trans('content_trans.Saeed') }}</h6>
                                        <p class="mb-0 small">{{ trans('content_trans.TutorofE') }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <svg enable-background="new 0 0 160.7 159.8" height="180px">
               ...
               <path d="m99.9 13.2c-1.2 0-2.1-1-2.1-2.2s1-2.2 2.1-2.2c1.2 0 2.1 1 2.1 2.2s-1 2.2-2.1 2.2z" />
                            ...
                            <div class="p-3 bg-primary d-inline-block rounded-4 shadow-lg text-center"
                                ...
                                <p class="text-white mb-0">{{ trans('content_trans.Based') }}</p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-5 mt-n6 mb-0 mb-md-5">
                            <div class="bg-body shadow text-center p-4 rounded-3">
                                ...
                                <!-- Info -->
                                <h6 class="mb-0">{{ trans('content_trans.Muna') }}</h6>
                            </div>
                        </div>
                    </div> <!-- Row END -->
                </div>
                <div class="col-xl-5 order-1 text-center text-xl-start">
                    <!-- Title -->
                    <h2 class="fs-1">{{ trans('content_trans.feedback') }}</h2>
                    <p>{{ trans('content_trans.bio') }}</p>
                </div>
            </div> <!-- Row END -->
        </div>
    </section>
               ...
               <div class="tiny-slider arrow-round arrow-blur arrow-hover rounded-3 overflow-hidden">
                   <div class="tiny-slider-inner" data-autoplay="false" data-gutter="0" data-arrow="true"
                       ...
                       <div class="card overflow-hidden h-500px h-md-600px text-center rounded-0"
                           style="background-image:url(assetshome/images/bg/01.jpg); background-position: center left; background-size: cover;">
                               ...
                               <div class="w-100 my-auto">
                                   <div class="row justify-content-center">
                                       <div class="col-11 col-lg-7">
                                           <!-- Title -->
                                           <h1 class="text-white display-6">{{ trans('slider_trans.Discover ') }}</h1>
                                           <p class="text-white">{{ trans('slider_trans.aboutDiscover') }}
                                           </p>
                       ...
                       <!-- Card item START -->
                       <div class="card overflow-hidden h-500px h-md-600px text-center rounded-0"
                           style="background-image:url(assetshome/images/bg/02.jpg); background-position: center left; background-size: cover;">
                           <!-- Background dark overlay -->
                           <div class="bg-overlay bg-dark opacity-6"></div>
                           <!-- Card image overlay -->
                               ...
                               <div class="w-100 my-auto">
                                   <div class="row justify-content-center">
                                       <div class="col-11 col-lg-6">
                                           ...
                                           <!-- Title -->
                                           <h1 class="mb-0 text-white display-6">{{ trans('slider_trans.electronic ') }} <br> 
                                               <span class="position-relative">{{ trans('slider_trans.Skills ') }}
                                                   <!-- SVG START -->
                                                   <span
