    ...
    <div class="row g-4">
      <!-- Title and SVG START -->
			<div class="col-10 text-center mx-auto position-relative">
				...
				<!-- Title -->
				<h1 class="position-relative fs-2">{{ trans('about_trans.Educational') }}</h1>
			</div>
    	<!-- Title and SVG END -->
		</div>
		...
		<div class="row g-4 mt-0 mt-lg-5">
			...
			<div class="col-6 col-md-4">
				<div class="row g-4">
					...
					<div class="col-10 col-lg-6">
						<img class="rounded-4" src="{{ asset('assetshome/images/about/05.jpg') }}" alt="">
					</div>
					<!-- Image -->
					<div class="col-12">
						<img class="rounded-4" src="{{ asset('assetshome/images/about/03.jpg') }}" alt="">
					</div>
				</div>
			</div>
			...
			<div class="col-6 col-md-4 position-relative">
				...
				<!-- Image -->
				<img class="rounded-4" src="{{ asset('assetshome/images/about/09.jpg') }}" alt="">
			</div>
			...
			<div class="col-md-4">
				<div class="row g-4">
					...
					<div class="col-sm-6 col-md-12">
						<div class="bg-success rounded-4 p-5 text-start">
						 <h5 class="text-white">{{ trans('about_trans.goal') }}</h5> 
							<h3 class="text-white">“{{ trans('about_trans.learn') }}”</h3>
						</div>
					</div>
					<!-- Image -->
					<div class="col-sm-6 col-md-12 col-lg-6">
						<img class="rounded-4" src="{{ asset('assetshome/images/about/10.jpg') }}" alt="">
					</div>
				</div>
			</div>
		</div>
...
<section class="pt-0 pt-md-5">
	<div class="container">
		...
		<div class="row mb-4">
			<div class="col-lg-8">
				<h3>{{ trans('about_trans.aboutschool') }}</h3>
				<h6>{{ trans('about_trans.contentaboutschool') }}</h6>
			</div>
		</div>

        <div class="row mb-4">
			<div class="col-lg-8">
				<h3>{{ trans('about_trans.Mess') }}</h2>
				<h6>{{ trans('about_trans.Message') }}</h6>
			</div>
		</div>
		...
		<div class="row align-items-center">
			<div class="col-lg-5 position-relative">
				...
				<!-- Image -->
				<img src="{{ asset('assetshome/images/about/06.jpg') }}" class="rounded" alt="">
			</div>

			<div class="col-lg-7 mt-4 mt-lg-0">
				<!-- Title -->
				<h4 class="mb-3">{{ trans('about_trans.title') }}</h4>

				<!-- Content -->
				<p>{{ trans('about_trans.content') }}</p>
				<!-- Info -->
				<ul class="list-group list-group-borderless mt-4">
					<h4>{{ trans('about_trans.goalcontent') }}</h4>
					<li class="list-group-item d-flex">
            <i class="bi bi-patch-check-fill text-success me-2"></i>{{ trans('about_trans.Ascension') }}
					</li>
					<li class="list-group-item d-flex">
            <i class="bi bi-patch-check-fill text-success me-2"></i>{{ trans('about_trans.Developing') }}
					</li>
					<li class="list-group-item d-flex">
            <i class="bi bi-patch-check-fill text-success me-2"></i>{{ trans('about_trans.Improving') }}

					</li>
					<li class="list-group-item d-flex">
            <i class="bi bi-patch-check-fill text-success me-2"></i>{{ trans('about_trans.Strengthening') }}
					</li>
				</ul>
{{-- 
				<!-- Progress bar START -->
