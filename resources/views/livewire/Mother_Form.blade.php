...
<div class="col-xs-12">
    <div class="col-md-12">
        ...
        @if ($updateMode)
            <button class="btn btn-success nextBtn btn-lg pull-right" style="margin-right: 5px" wire:click="secondStepSubmit_edit"
                type="button">{{ trans('Parent_trans.Next') }}
            </button>
        @else
            {{-- wire:click -> الضغطة تاعت البوتون --}}
            <button class="btn btn-success nextBtn btn-lg pull-right" style="margin-right: 5px" type="button"
