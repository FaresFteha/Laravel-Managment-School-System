...
return [
    ...
    'Attachments' => 'اختر المرفقات الخاصة',
    'add_parent' => 'اضافة ولي امر',
    'Processes' => 'العمليات',

    'Cpanelparents'=>'لوحة تحكم اولياء الامور',
    'studentchilde'=>'ابنائك الطلبة',
    'Studentinformation'=>'معلومات الطالب',
    'childrenlist'=> 'قائمة الابناء',
    'testresults'=> 'عرض نتائج الاختبارات الالكترونية',
    'smsterexamresults'=> 'عرض نتائج الاختبارات الفصلية',
    'studentcode'=>'يوجد خطا في كود الطالب',
    'nopayments'=>'لا توجد مدفوعات لهذا الطالب',
